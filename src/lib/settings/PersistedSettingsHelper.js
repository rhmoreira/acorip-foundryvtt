...
export class TokenSettingHelper {
    #toggleTokenImageKey = SETTINGS_CONF.toggleTokenImage;
    #playerToggleTokenImageKey = SETTINGS_CONF.playerToggleTokenImage;
    #netrunningEffectFileKey = SETTINGS_CONF.netrunningEffectFile;
